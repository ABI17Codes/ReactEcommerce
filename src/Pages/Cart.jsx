...
const Cart = () => {
  const { products, currency, cartItem, UpdataQuantity, navigate } = useContext(ShopContext);
        ...
        {cartData.map((item, index) => {
          ...
          return (
            ...
            >
              ...
              <input
              onChange={(e)=>e.target.value === " " || e.target.value === "0" ? null : UpdataQuantity(item._id,item.size,Number(e.target.value))}
